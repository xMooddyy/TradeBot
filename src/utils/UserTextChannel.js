...
class UserTextChannel {
    constructor(options) {
        ...
        this.notifications.on('newTrade', this.handleNotification.bind(this));
    }
    async init() {
    ...
    async handleNotification(trades) {
    ...
    async unInit() {
        this.notifications.removeListener('newTrade', this.handleNotification.bind(this));
				console.log(this.notifications.listenerCount(), this.notifications.listeners())
    }
}
